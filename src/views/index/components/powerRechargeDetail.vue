<template>
  <div class="telephoneExpenses">
    <div class="detail-account">
      <div class="top">
        <div class="top-left">
          <img src="@/assets/img/countryPower.png" alt="">
          <!-- <img src="@/assets/img/southPower.png" alt=""> -->
          <div class="power-type">国家电网</div>
        </div>
        <div class="account-record">此账号缴费记录</div>
      </div>
      <div class="power-icon">
        <img src="@/assets/img/power.png" alt="">
        <div>电费充值</div>
      </div>
      <Cell class="cell cell1">
        <template #title>
          <span class="title">可用余额</span>
        </template>
        <template #default>
          <span class="value">29.2元</span>
        </template>
      </Cell>
      <Cell :border="false" class="cell">
        <template #title>
          <span class="title">充值区域</span>
        </template>
        <template #default>
      ...
      <Cell :border="false" class="cell">
        <template #title>
          <span class="title">缴费户名</span>
        </template>
        <template #default>
          <span class="value">力</span>
        </template>
      </Cell>
      <Cell :border="false" class="cell">
        <template #title>
          <span class="title">缴费户号</span>
        </template>
        <template #default>
          <span class="value">121231321231231231</span>
        </template>
      </Cell>
      <Cell :border="false" class="cell">
        <template #title>
